...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    //5. creamos el método que actualiza el nombre, apellidos y correo del usuario
    public void actualizarEmpleado(){
        ...
        if (nombre.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "El valor del campo es requerido", "",JOptionPane.WARNING_MESSAGE);
        } else if (correo.isEmpty()) {
            JOptionPane.showMessageDialog(this, "El correo del empleado es una campo requerido", "",JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "No fue posible actulizar los datos del empleao","", JOptionPane.ERROR_MESSAGE);
            }
            this.dispose();
        }
    }
    
    public void ElimnarEmpleado(){
        //1. Consulatamos el Id del empleado
        int idEmp = Integer.parseInt(txtId.getText());
        //3. validar si el usuario no ha selecionado empleado
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtTipoDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
